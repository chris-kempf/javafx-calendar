...
public class FullCalendarView {
	private static final Text[] dayNames = new Text[] { new Text("Sunday"), new Text("Monday"), new Text("Tuesday"),
	...
	public FullCalendarView(YearMonth yearMonth) {
		...
		calendarTitle.setPadding(new Insets(1, 4, 1, 4));
		...
		titleBar.setPadding(new Insets(1, 4, 1, 4));
